    ...
    return (
        <div>
            ...
            <div className="resume-item">
                ...
                <p>Relevant Coursework: Analysis of Algorithms, Networks, Distributed Systems, Neural Networks,
                    DB Implementation, Software Engineering</p>
            </div>

            <div className="resume-item">
                <h4>Bachelor of Engineering - Computer Science and Engineering</h4>
                <p className="mb-0"><em><b>Osmania University, </b></em><h5>2017-2021</h5> <h5>8.1 CGPA</h5><i
                    className="arrow down "></i></p>
                <p>Relevant Coursework: Artificial Intelligence, Machine Learning, Compiler Design,
