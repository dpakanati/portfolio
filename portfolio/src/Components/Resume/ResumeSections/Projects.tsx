    ...
    return (
        <div>
            ...
            <div className="resume-item">
                <h4>My Movie List</h4>
                <p className=""><em><b>University of Florida, </b><h5>Full Stack</h5></em>
                    <i className="arrow down arrow-small-screen"/>
                </p>
                <p>
                    <ul>
                        ...
                        {(window.innerWidth > 768 || expandDescription) && (
                            <div className="expanded-description">
                                <li>
                                    Worked in a team to implement back end using Golang and front end using Angular,
                                    Bootstrap,
                        ...
                        {(window.innerWidth <= 768) && (
                            <p className="text-decoration-underline" onClick={toggleDescription}>
            ...
            <div className="resume-item">
                ...
                <p className=""><em><b>University of Florida, </b><h5>Kotlin</h5> <h5>MVVM</h5></em>
                    <i className="arrow down arrow-small-screen"/>
                </p>

                <p>
                    <ul>
                        <li>A native android application that imitates working of twitter including functionalities of
                            login,
                        ...
                        <div className="expand-text">
                            <li>
                                ...
                                Integrated fragments into activity using ViewPager2. Populated posts from the firebase
                                using
                                Recycler Views.
                            </li>
                            <li>
                                Used MVVM architecture with principles of LiveData to observe changes and update views.
                                Used
                                Dagger hilt for dependency injection and Retrofit as Http Client to consume RESTful APIs
                                in
                                the application.
                            </li>
                            <li>
                                Implemented authentication and user login using Firebase authentication. Stored User and
                                Tweet collection in Firebase Database along with Firebase Storage to store user
                                generated
                                content(Images).
                            </li>
                        </div>
            ...
            <div className="resume-item ">
                ...
                <p className=""><em><b>University of Florida, </b><h5>Erlang</h5></em>
                    <i className="arrow down arrow-small-screen"/></p>
                <p>
                    <ul>
            ...
            <div className="resume-item text-justify ">
                <h4>IoT Crop Suggestion</h4>
                <p className=""><em><b>Osmania University, </b><h5>KNN</h5> <h5>IoT</h5> <h5>Raspberry Pi</h5></em>
                    <i className="arrow down arrow-small-screen"/></p>
                <p>
                    <ul>
                        ...
                        <div className="expand-text">
                            ...
                            <li>
                                The real-time data from soil sensors ensures accurate and dynamic recommendations,
                                enabling
            ...
            <div className="resume-item text-justify ">
                ...
                <p className=""><em><b>University of Florida, </b><h5>Neural Networks</h5></em>
                    <i className="arrow down arrow-small-screen"/></p>
                <p>
                    <ul>
                        ...
                        <div className="expand-text">
                            <li>
                                ...
                                Optimized the RNN using a validation set and retrained the RNN. Reported the new
                                prediction
